    ...
    if(name){
        return (
            <div className={"col-lg-4 mb-4"}>
                <div className={"position-relative"} onMouseLeave={()=>setFeaturedProductUnHovered(!featuredProductUnHovered)}
                     onMouseEnter={()=>setFeaturedProductUnHovered(!featuredProductUnHovered)} style={{height:"14rem",cursor:"pointer"}}>
